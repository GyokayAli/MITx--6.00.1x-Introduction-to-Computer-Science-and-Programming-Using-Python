...
WORDLIST_FILENAME = "C:\Users\Gyoki\MIT6001x\ProblemSet4\words.txt"
...
def playGame(wordList):
    ...
    playerHand = None
    while option != 'e':
        option = raw_input("Enter n to deal a new hand, r to replay the" +
                                  "  last hand, or e to end game: ").lower()
        if option == 'n':
            playerHand = dealHand(HAND_SIZE)
            playHand(playerHand.copy(), wordList, HAND_SIZE)
            print
        elif option == 'r':
            if playerHand != None:
                playHand(playerHand.copy(), wordList, HAND_SIZE)
